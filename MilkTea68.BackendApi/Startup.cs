...
namespace MilkTea68.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<MilkTea68DbContext>(options =>
            options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));
            services.AddControllers();

            services.AddIdentity<AppUser, AppRole>()
                .AddEntityFrameworkStores<MilkTea68DbContext>()
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MilkTea68", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger MilkTea68");
            });
